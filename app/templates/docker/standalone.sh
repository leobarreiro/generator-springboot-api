...
<% if (rabbit) { %>docker run --name <%=artifact%>-rabbit -d -p 5672:5672 -p 15672:15672 -m 256m -e RABBITMQ_DEFAULT_USER=<%=artifact%> -e RABBITMQ_DEFAULT_PASS=<%=randomPasswd%> rabbitmq:3.7.14-management-alpine<% } %>
